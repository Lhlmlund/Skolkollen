  ...
  <main class="results">
    ...
    <section class="box">
      <template v-if="latest">
        <p class="big"><span>Rekommendation:</span> {{ latest.recommendation }}</p>
...
.box {
  ...
  box-shadow: 0 8px 24px rgba(0,0,0,.06); max-width: 720px; margin: 0 auto;
}
.big { font-size: 1.1rem; margin: 0 0 6px; color: #2b2b2b; }
.big span { font-weight: 700; margin-right: 6px; }
.time { opacity: .75; margin: 0 0 10px; }
.btn { display: inline-block; padding: 6px 12px; border-radius: 10px; border: 1px solid #e0e0e0; text-decoration: none; }
</style>
