<template>
  <main class="selected-schools-page">
    <h2>Utvalda skolor</h2>
    <p class="intro">Här hittar du ett urval av skolor med detaljerad information.</p>
